...
export default function DrachmannChairPage() {
  ...
  const product = {
    ...
    year: '1982',
    price: 9699,
    description: 'The Drachmann series was designed by Bernt Santesson in 1982, and is inspired by the beautiful garden of the Danish poet and painter Holger Drachmann. The chair is a balance between Nordic nostalgia and modern simplicity. Made to order item with approximately 8 weeks delivery time.',
    category: 'Seating',
    ...
    specifications: {
      ...
      'Care Instructions': 'Clean with mild soap and water. Apply teak oil annually for best appearance.'
    },
    features: [
      'Designed by Bernt Santesson in 1982',
      'Inspired by Holger Drachmann\'s beautiful garden',
      'Balance between Nordic nostalgia and modern simplicity',
      'Certified solid teak wood construction',
      'Weather-resistant outdoor design',
      'Comfortable dining height',
      'Durable and long-lasting',
      'Compatible with Drachmann seat cushion',
      'Made to order - 8 weeks delivery time'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Drachmann chair /lifestyle/10419384_2.webp',
        alt: 'Drachmann chair in outdoor dining setting'
      },
      {
        src: '/Fritz Hansen/Drachmann chair /lifestyle/10419384_3.webp',
        alt: 'Drachmann chair lifestyle shot'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-sm font-medium text-blue-800">Complete Your Set</h4>
                  <p className="text-sm text-blue-700 mt-1">
                    Add comfort with our <Link href="/fritz-hansen/drachmann-seat-cushion" className="underline hover:no-underline">Drachmann Seat Cushion</Link> available in multiple colors.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Complete Your Drachmann Collection
          </h2>
          <div className="text-center space-y-4">
            <Link 
              href="/fritz-hansen/drachmann-seat-cushion"
