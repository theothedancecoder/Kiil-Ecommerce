...
export default function SkagerakCutterWardrobePage() {
  ...
  const product = {
    ...
    year: '2020',
    price: 8999,
    description: 'Starting from a simple bench, the Cutter design has been continuously developed so that the series today consists of a number of beautifully designed utility products for the entire home. Teak, oak and stainless steel are the consistent materials, and the exclusive design testifies to uncompromising and rich craftsmanship. Made to order item with approximately 4 weeks delivery time.',
    ...
    variants: [
      ...
      {
        name: 'Oak',
        image: '/Fritz Hansen/Skagerak-Cutter-Wardrobe/Skagerak Cutter Wardrobe NOK  8,999  Base -  Oak.webp',
        material: 'Solid oak',
        finish: 'Natural oak',
        price: 8999
      },
      {
        name: 'Black',
        image: '/Fritz Hansen/Skagerak-Cutter-Wardrobe/Skagerak Cutter Wardrobe NOK  9,399  Base -  Black.webp',
    ...
    specifications: {
      ...
      'Height': '13 cm',
      'Weight': '9.4 kg',
      'Dimensions (Packaged)': '125 × 35 × 18 cm',
      'Material': 'Oak/Teak construction',
      'Base Options': 'Oak, Black, Teak',
      'Designer': 'Niels Hvass',
      'Brand': 'Skagerak/Fritz Hansen',
      'Collection': 'Cutter',
    ...
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Skagerak-Cutter-Wardrobe/lifestyle/23296_image_3-scaled.webp',
        alt: 'Skagerak Cutter Wardrobe in modern bedroom setting'
      },
      {
        src: '/Fritz Hansen/Skagerak-Cutter-Wardrobe/lifestyle/23296_image_5-scaled.webp',
        alt: 'Skagerak Cutter Wardrobe lifestyle detail shot'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mt-1">
                    This item is made to order. Expected delivery time is approximately 6 weeks.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Explore More Skagerak by Fritz Hansen
          </h2>
