...
export default function OrientP2PendantPage() {
  ...
  const product = {
    ...
    variants: [
      ...
      {
        name: 'Aluminum',
        image: '/Fritz Hansen/Orient™-P2-pendant/Orient™ P2 pendant kr  7 299  Color -  Aluminum.png',
        material: 'Aluminum',
      ...
      {
        name: 'Copper',
        image: '/Fritz Hansen/Orient™-P2-pendant/Orient™ P2 pendant NOK  9,999  Color -  Copper.png',
        material: 'Copper',
        finish: 'Warm copper',
        price: 9999
      }
    ...
    specifications: {
      ...
      'Material Options': 'Aluminum, Matte black aluminum, Copper',
      'Designer': 'Jo Hammerborg',
      'Brand': 'Fritz Hansen',
      'Collection': 'Orient',
      'Original Design Year': '1963',
      'Relaunch Year': '2013',
      'Delivery Time': 'Approximately 6 weeks (made to order)',
      'Installation': 'Ceiling mounted pendant'
    },
    features: [
      'Designed by Jo Hammerborg in 1963',
      'Relaunched in new materials in 2013',
      'Provides soft, ambient lighting',
      'Available in three premium finishes',
      'Timeless Danish design classic',
      'Perfect for dining areas and living spaces',
      'Made to order craftsmanship',
      'Part of the iconic Orient collection',
      'Sculptural lighting element',
      'Premium material construction'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Orient™-P2-pendant/lifestyle/6625_Orient7.webp',
        alt: 'Orient P2 Pendant in modern interior setting'
      },
      {
        src: '/Fritz Hansen/Orient™-P2-pendant/lifestyle/9914_Orient_Aluminium___Pendant7.webp',
        alt: 'Orient P2 Pendant aluminum finish lifestyle'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Explore More Fritz Hansen Lighting
          </h2>
