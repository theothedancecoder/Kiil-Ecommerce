...
export default function SkagerakCutterBoxPage() {
  ...
  const product = {
    ...
    variants: [
      ...
      {
        name: 'Black',
        image: '/Fritz Hansen/Skagerak-Cutter-Box/Skagerak Cutter Box NOK  2,999  Base -  Black.png',
        material: 'Solid oak',
        finish: 'Black oak',
        price: 2999
      }
    ...
    specifications: {
      ...
      'Height': '34 cm',
      'Weight': '4 kg',
      'Dimensions (Packaged)': '35 × 40 × 40 cm',
    ...
    features: [
      ...
      'High drawer design for storage',
      ...
      'Versatile utility furniture'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Skagerak-Cutter-Box/lifestyle/cutter_box_lifestyle1.jpg',
        alt: 'Skagerak Cutter Box in modern home setting'
      }
    ]
  };
