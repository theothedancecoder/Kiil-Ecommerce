...
export default function NorrMagazineHolderPage() {
  ...
  const product = {
    ...
    year: '2024',
    price: 3299,
    description: 'Norr magazine holder is a practical wall-mounted shelf for newspapers and magazines. Made to order item with approximately 4 weeks delivery time.',
    category: 'Accessories',
    collection: 'Norr',
    brand: 'Skagerak by Fritz Hansen',
    variants: [
      {
        name: 'Untreated Oak/Leather',
        image: '/Fritz Hansen/Norr Magazine Holder/Norr Magazine Holder kr  3 299.webp',
        material: 'Untreated oak with leather',
        finish: 'Natural oak'
      }
    ],
    specifications: {
      ...
      'Height': '35 cm',
      'Weight': '2.3 kg',
      'Dimensions': '75 × 10 × 35 cm',
      'Material': 'Untreated oak with leather',
      'Designer': 'Ditte Buus Nielsen',
      'Brand': 'Skagerak by Fritz Hansen',
      'Collection': 'Norr',
      'Delivery Time': 'Approximately 4 weeks (made to order)',
      'Care Instructions': 'Clean with dry cloth. Apply wood oil occasionally for best appearance.'
    },
    features: [
      'Designed by Ditte Buus Nielsen',
      'Practical wall-mounted shelf',
      'Perfect for newspapers and magazines',
      'Untreated oak construction with leather details',
    ...
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Norr Magazine Holder/lifestyle/norr_lifestyle_1.webp',
        alt: 'Norr magazine holder in modern interior setting'
      },
      {
        src: '/Fritz Hansen/Norr Magazine Holder/lifestyle/norr_lifestyle_2.webp',
        alt: 'Norr magazine holder wall-mounted lifestyle shot'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-sm font-medium text-blue-800">Wall-Mounted Design</h4>
                  <p className="text-sm text-blue-700 mt-1">
                    This magazine holder is designed for wall mounting. Installation hardware may be required (not included).
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Explore More Fritz Hansen Accessories
          </h2>
