...
export default function SwanChairLeatherPage() {
  ...
  const product = {
    ...
    year: '1958',
    price: 77499,
    description: 'The design icon The Swan was designed by Arne Jacobsen in 1958 and used at the SAS Royal Hotel in Copenhagen in 1960. Made to order item with approximately 8 weeks delivery time.',
    category: 'Seating',
    collection: 'Swan',
    brand: 'Fritz Hansen',
    variants: [
      {
        ...
        material: 'Essential leather',
        color: 'Light Grey',
        price: 77499
      },
      {
        name: 'Essential Walnut',
        image: '/Fritz Hansen/Swan-chair-in-leather/Svanen stol i skinn kr 77 499  Farge - Essential leather : Walnut.png',
        material: 'Essential leather',
        color: 'Walnut',
        price: 77499
      },
      {
        ...
        material: 'Aura leather',
        color: 'Black',
        price: 89999
      },
      {
        name: 'Embrace Concrete Grey',
        image: '/Fritz Hansen/Swan-chair-in-leather/Swan chair in leather NOK  105,499  Color -  Embrace leather : Concrete Grey.png',
        material: 'Embrace leather',
        color: 'Concrete Grey',
        price: 105499
      }
    ],
    specifications: {
      ...
      'Care Instructions': 'Professional leather cleaning recommended. Avoid direct sunlight.'
    },
    features: [
      ...
      'Multiple leather types and colors available',
      'Timeless Danish design masterpiece',
      'Made to order - 8 weeks delivery time'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Swan-chair-in-leather/lifestyle/fh_swan_3320_walnut_planner_mc330_creme_ikeru.avif',
        alt: 'Swan Chair in elegant interior setting'
      },
      {
        src: '/Fritz Hansen/Swan-chair-in-leather/lifestyle/fh_egg_3316_walnut_swan_3320_walnut_planner_mc330_creme_1.avif',
        alt: 'Swan Chair with Egg Chair lifestyle shot'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Explore More Fritz Hansen Icons
          </h2>
