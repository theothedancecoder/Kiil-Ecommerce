...
export default function RegattaBenchPage() {
  ...
  const product = {
    ...
    designer: 'Hans Thyge & Co. Design Studio',
    year: '2024',
    price: 29999,
    description: 'Elegant outdoor bench that completes the Regatta collection with comfortable seating for two. Made to order item with approximately 6 weeks delivery time.',
    category: 'Seating',
    collection: 'Regatta',
    ...
    specifications: {
      ...
      'Brand': 'Skagerak by Fritz Hansen',
      'Collection': 'Regatta',
      'Delivery Time': 'Approximately 6 weeks (made to order)',
      'Care Instructions': 'Clean with mild soap and water. Apply teak oil annually for best appearance.'
    },
    features: [
      'Made from 100% FSC-certified teak',
      'Minimalist expressions with soft curves',
      'Weather-resistant outdoor construction',
      'Designed by Hans Thyge & Co. Design Studio',
      'Part of the complete Regatta collection',
      'Made to order - 6 weeks delivery time'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Regatta-Bench/lifestyle/Regatta_Cam01_Main_v06.jpg',
        alt: 'Regatta Bench in outdoor setting'
      },
      {
        src: '/Fritz Hansen/Regatta-Bench/lifestyle/Regatta-2-seater.jpg',
        alt: 'Regatta Bench lifestyle shot'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Complete the Regatta Collection
          </h2>
