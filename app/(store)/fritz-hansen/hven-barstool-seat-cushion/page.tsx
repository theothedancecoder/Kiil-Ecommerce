...
export default function HvenBarstoolSeatCushionPage() {
  ...
  const product = {
    ...
    year: '2024',
    price: 2499,
    description: 'Seat cushion in Aniline leather for Hven bar stool. Made to order item with approximately 8 weeks delivery time.',
    ...
    variants: [
      {
        ...
        material: 'Aniline leather from Sørensen Leather',
        backing: 'Neoprene backing'
      }
    ],
    specifications: {
      'Width': '40 cm',
      ...
      'Height': '5 cm',
      'Weight': '0.5 kg',
      'Dimensions': '40 × 42 × 5 cm',
      'Material': 'Aniline leather from Sørensen Leather',
      'Backing': 'Neoprene backing',
      'Compatibility': 'Hven Bar Stool',
      'Designer': 'Anton Björsing',
      'Brand': 'Skagerak by Fritz Hansen',
      'Collection': 'Hven',
      'Delivery Time': 'Approximately 8 weeks (made to order)',
      'Care Instructions': 'Clean with leather care products. Avoid direct sunlight and moisture.'
    },
    features: [
      'Designed by Anton Björsing',
      'Premium Aniline leather from Sørensen Leather',
      'Neoprene backing for durability',
      'Designed specifically for Hven bar stool',
      'High-quality leather construction',
      'Comfortable seating enhancement',
      'Professional leather finishing',
      'Made to order - 8 weeks delivery time'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Seat-cushion-for-Hven-barstool /lifestyle/1950538_1950530_1420010_02_m-jpg-scaled.webp',
        alt: 'Hven barstool seat cushion in modern interior setting'
      },
      {
        src: '/Fritz Hansen/Seat-cushion-for-Hven-barstool /lifestyle/12.webp',
        alt: 'Hven barstool seat cushion lifestyle shot'
      }
    ]
  };
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Seat cushion in Aniline leather for Hven bar stool. Premium leather from Sørensen Leather with neoprene backing for enhanced comfort and durability.
              </p>
              <div className="mt-4 text-sm text-gray-500">
                Designed by {product.designer} • Produced by {product.brand}
              </div>
            </div>
              ...
              <div className="space-y-3">
                {product.variants.map((variant, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600">{variant.backing}</div>
                  </button>
                ))}
              </div>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    This cushion is designed specifically for the Hven bar stool and may not fit other stool models.
                  </p>
                </div>
              </div>
            </div>
