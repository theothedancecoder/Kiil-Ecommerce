...
export default function Flos2097Display() {
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <h1 className="text-3xl font-light mb-2">{flos2097Chandelier.name}</h1>
            <p className="text-lg text-gray-600 mb-4">{flos2097Chandelier.model}</p>
            <p className="text-2xl font-light">{flos2097Chandelier.price}</p>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-800">{flos2097Chandelier.model}</p>
            </div>
          </div>
