...
const flos209750Chandelier = {
  name: "2097/50",
  model: "2097/50 (frosted bulbs)",
  price: "89,999 kr",
  bulbs: "50 x E14",
...
export default function Flos209750Display() {
  const [selectedVariant, setSelectedVariant] = useState(flos209750Chandelier.variants[0]);
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-6">
          ...
          >
            <Image
              ...
              alt={`${flos209750Chandelier.name} in ${selectedVariant.color}`}
              fill
          ...
          <div className="flex gap-3">
            {flos209750Chandelier.variants.map((variant) => (
              <button
                key={variant.id}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <h1 className="text-3xl font-light mb-2">{flos209750Chandelier.name}</h1>
            <p className="text-lg text-gray-600 mb-4">{flos209750Chandelier.model}</p>
            <p className="text-2xl font-light">{flos209750Chandelier.price}</p>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-800">{flos209750Chandelier.model}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-600">
              ...
              <div className="flex justify-between">
                <span>Bulbs:</span>
                <span>{flos209750Chandelier.bulbs}</span>
              </div>
              <div className="flex justify-between">
                <span>Dimensions:</span>
                <span>{flos209750Chandelier.dimensions}</span>
              </div>
              <div className="flex justify-between">
                <span>Designer:</span>
