...
const lightingCollections = [
  {
    id: 1,
    name: "FLOS Collection",
    image: "/FLOS/2097%3A18%20lysekrone%20/Brass.jpg",
    route: "/interior/living-room/lighting/flos",
    maker: "FLOS",
    description: "Italian luxury lighting design"
  }
];
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
              {lightingCollections.map((collection) => (
                <div
                  key={collection.id}
