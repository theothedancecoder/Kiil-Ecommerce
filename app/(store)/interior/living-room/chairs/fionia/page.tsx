...
const fioniaColors = [
  {
    ...
    description: "Natural untreated oak with beautiful grain patterns",
    price: "3,999 kr",
    colorCode: "#D2B48C",
  },
  {
    id: 2,
    name: "Untreated Teak",
    image: "/Fionia/Color -  Untreated teak.webp",
    description: "Premium untreated teak with rich natural tones",
    price: "5,999 kr",
    colorCode: "#B8860B",
  }
];

export default function FioniaPage() {
  const [selectedColor, setSelectedColor] = useState(fioniaColors[0]);
          ...
          <div className="flex items-center justify-center bg-gray-50 p-8">
            <div className="relative w-full max-w-lg aspect-square">
              <Image
                ...
                alt={selectedColor.name + " Fionia Stool"}
                fill
