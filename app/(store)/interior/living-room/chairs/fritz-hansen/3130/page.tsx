...
const fritzHansen3130Colors = [
  ...
  },
  {
    id: 2,
    name: "Walnut",
    image: "/Fritz Hanson  3130/Clear Lacquered Veneer : Walnut.png",
  ...
  },
  {
    id: 3,
    name: "Deep Clay",
    image: "/Fritz Hanson  3130/Coloured Veneer : Ash - Deep Clay (145).png",
    description: "Coloured ash veneer in warm clay finish",
    price: "6,499 kr",
    colorCode: "#A0522D",
  },
  {
    ...
    description: "Coloured ash veneer in deep blue finish",
    price: "6,499 kr",
    colorCode: "#191970",
  }
];

export default function FritzHansen3130Page() {
  const [selectedColor, setSelectedColor] = useState(fritzHansen3130Colors[0]);
          ...
          <div className="flex items-center justify-center bg-gray-50 p-8">
            <div className="relative w-full max-w-lg aspect-square">
              <Image
                ...
                alt={selectedColor.name + " Fritz Hansen 3130"}
                fill
          ...
          <div className="flex flex-col justify-center p-8 lg:p-16 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                {fritzHansen3130Colors.map((color) => (
                  <button
                    key={color.id}
