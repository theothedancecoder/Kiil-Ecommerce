...
export default async function DecorProductPage({ params }: ProductPageProps) {
  const resolvedParams = await params;
  const productId = resolvedParams.productId;

  // Find the product in our decor data
  const product = decorData.find(p => p.slug.current === productId);
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-stone-600">
            ...
            <span>/</span>
            <Link href="/interior/home-accessories/decor" className="hover:text-stone-800">Decor</Link>
            <span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Product Details */}
          <DecorProductClient product={product} />
        </div>

        {/* Related Products */}
        <div className="mt-16">
          <h2 className="text-2xl font-serif text-primary mb-8">Related Decor</h2>
            ...
            {decorData
              ...
              .map((relatedProduct) => (
                <Link
                  ...
                  href={`/interior/home-accessories/decor/${relatedProduct.slug.current}`}
                  className="group"
                >
...
// Generate static params for all decor products
export async function generateStaticParams() {
  return decorData.map((product) => ({
