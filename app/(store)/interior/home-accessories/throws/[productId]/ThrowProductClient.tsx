...
import { ThrowsProduct } from "@/lib/throwsData";

interface ThrowProductClientProps {
  product: ThrowsProduct;
}

export default function ThrowProductClient({ product }: ThrowProductClientProps) {
