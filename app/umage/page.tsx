    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <ProductionImage
            src={banner?.bannerImage ? imageUrl(banner.bannerImage).width(1200).height(500).url() : 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80'}
            alt={banner?.title || "Umage Audacious Desk Collection"}
            fill
