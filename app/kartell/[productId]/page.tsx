...
export default async function KartellProductPage({ params }: ProductPageProps) {
  ...
  return <KartellProductClient product={product} />;
}

// Generate static params for all Kartell products
export async function generateStaticParams() {
  const kartellProducts = [
    'componibili-classic-2',
    'componibili-classic-3',
    'kabuki-hanging',
    'big-battery',
    'pumo-lamp',
    'kabuki-floor-lamp',
  ...
  return kartellProducts.map((productId) => ({
    productId,
  }));
}
