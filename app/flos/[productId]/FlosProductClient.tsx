...
import { getFlosProductBySlug, FlosProduct } from "@/sanity/lib/products/getFlosProducts";
...
interface FlosProductClientProps {
  params: {
    productId: string;
  };
}

export default function FlosProductClient({ params }: FlosProductClientProps) {
  ...
  useEffect(() => {
    async function fetchProduct() {
      ...
      setError(null);
      try {
        const fetchedProduct = await getFlosProductBySlug(slug);
        if (!fetchedProduct) {
