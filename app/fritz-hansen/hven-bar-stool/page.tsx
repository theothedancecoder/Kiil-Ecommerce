...
export default function HvenBarStoolPage() {
  ...
  const product = {
    ...
    variants: [
      ...
      {
        name: 'Oiled Oak',
        image: '/Fritz Hansen/Hven-bar-stool/Hven bar stool from Skagerak NOK  10,499  Color -  Oiled oak.jpg',
        material: 'Solid oak',
        finish: 'Oiled oak',
        price: 10499
      },
      {
        name: 'Soaped Oak',
        image: '/Fritz Hansen/Hven-bar-stool/Hven bar stool from Skagerak NOK  10,499  Color -  Soaped oak.jpg',
        material: 'Solid oak',
        finish: 'Soaped oak',
        price: 10499
      },
      {
        name: 'White Pigmented Oak',
        image: '/Fritz Hansen/Hven-bar-stool/Hven bar stool from Skagerak NOK  10,499  Color -  White pigmented oak.jpg',
        material: 'Solid oak',
        finish: 'White pigmented oak',
        price: 10499
      }
    ],
    specifications: {
      ...
      'Seat Height': '67 cm',
      'Weight': '6 kg',
      'Dimensions (Packaged)': '50 × 47 × 90 cm',
      'Material': 'Solid oak construction',
      'Finish Options': 'Untreated oak, Oiled oak, Soaped oak, White pigmented oak',
      'Designer': 'Anton Björsing',
      'Brand': 'Skagerak/Fritz Hansen',
      'Collection': 'Hven',
    ...
    features: [
      ...
      'Both robust and elegant construction',
      'Excellent seating comfort',
      'Solid oak construction',
      'Available in four premium finishes',
      'Perfect bar stool height (67cm seat)',
      'Made to order craftsmanship',
      'Sustainable wood sourcing',
      'Timeless Scandinavian design',
      'Durable construction for daily use',
      'Versatile for kitchen islands and bars'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Hven-bar-stool/lifestyle/1420026-1420026_1961038_1961039_hven_bar_stool_86_m.webp',
        alt: 'Hven Bar Stool in modern kitchen setting'
      },
      {
        src: '/Fritz Hansen/Hven-bar-stool/lifestyle/1420026-1420026_hven_bar_stool_86_m_1.webp',
        alt: 'Hven Bar Stool lifestyle detail shot'
      }
    ]
  };
