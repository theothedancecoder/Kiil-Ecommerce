...
export default function SkagerakCutterBoxLowPage() {
  ...
  const product = {
    ...
    variants: [
      ...
      {
        name: 'Teak',
        image: '/Fritz Hansen/Skagerak-Cutter-Box-Low/Skagerak Cutter Box Low kr  1 549  Base -  Teak.webp',
        material: 'Solid teak',
        finish: 'Natural teak',
        price: 1549
      },
      {
        name: 'Black',
        image: '/Fritz Hansen/Skagerak-Cutter-Box-Low/Skagerak Cutter Box Low kr  1 599  Base -  Black.webp',
        material: 'Solid oak',
        finish: 'Black oak',
        price: 1599
      }
    ...
    specifications: {
      ...
      'Height': '14 cm',
      'Weight': '1.5 kg',
      'Dimensions (Packaged)': '33 × 29 × 17 cm',
    ...
    features: [
      ...
      'Low drawer design for compact storage',
      'Evolved from simple bench concept',
      ...
      'Perfect for small space organization',
      'Compact and lightweight design',
      'Versatile low-profile storage solution'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Skagerak-Cutter-Box-Low/lifestyle/cutter_box_low_lifestyle1.jpg',
        alt: 'Skagerak Cutter Box Low in modern home setting'
      }
    ]
  };
