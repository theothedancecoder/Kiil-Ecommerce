...
export default function FioniaStoolPage() {
  ...
  const product = {
    ...
    year: '1986',
    price: 3799,
    description: 'Modern take on the old X-chair. The lightweight stool is foldable and has a simple triangular construction with a sturdy surface that can be used as a bedside table or a small side table. Made to order item with approximately 4 weeks delivery time.',
    category: 'Seating',
    collection: 'Fionia',
    ...
    specifications: {
      ...
      'Height': '44 cm',
      'Weight': '5.1 kg',
      'Dimensions (Folded)': '50 × 10 × 45 cm',
      'Material': 'Untreated oak/teak',
      'Designer': 'Jens H. Quistgaard',
      'Brand': 'Skagerak/Fritz Hansen',
      'Year': '1986',
      'Collection': 'Fionia',
      'Delivery Time': 'Approximately 4 weeks (made to order)',
      'Care Instructions': 'Clean with dry cloth. Apply wood oil periodically for best appearance.'
    },
    features: [
      'Modern take on the classic X-chair design',
      'Lightweight and foldable construction',
      'Simple triangular construction',
      'Sturdy surface for multiple uses',
      'Can be used as bedside table or side table',
      'Available in untreated oak or teak',
      'Designed by Jens H. Quistgaard in 1986',
      'Made to order - 4 weeks delivery time'
    ],
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Fionia/Lifestyle/Fionia Stool Oak 03.jpg',
        alt: 'Fionia Stool in modern interior setting'
      },
      {
        src: '/Fritz Hansen/Fionia/Lifestyle/abt_714277583385747069MjAzNDIw.jpg-l.jpg',
        alt: 'Fionia Stool lifestyle shot'
      }
    ]
  };
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`${product.name} - ${product.variants[selectedVariant].name}`}
                fill
