...
export default function SkagerakCutterBenchPage() {
  ...
  const product = {
    ...
    year: 'Contemporary',
    price: 12499,
    description: 'The stylish Cutter series began as a counterbalance to the nostalgic and romantic design that has been the norm for wooden garden benches for many years. Designer Niels Hvass therefore focused his design on a clean, simple and sculptural expression, creating a bench that is so distinctive in its design language and has such a wide range of uses that it is now one of Skagerak\'s most popular pieces of furniture. Starting from a simple bench, the Cutter design has been continuously developed so that the series today consists of a range of beautifully designed utility products for the entire home. Teak, oak and stainless steel are the consistent materials, and the exclusive design testifies to uncompromising and rich craftsmanship. This is a made to order item with approximately 4 weeks delivery time.',
    category: 'Seating',
    collection: 'Cutter',
    ...
    variants: [
      ...
      {
        name: 'Teak',
        image: '/Fritz Hansen/Skagerak-Cutter-Bench/Skagerak Cutter Bench NOK  12,499  Variants -  Teak.jpg',
        material: 'Solid teak',
        finish: 'Natural teak',
        price: 12499
      },
      {
        name: 'Black',
        image: '/Fritz Hansen/Skagerak-Cutter-Bench/Skagerak Cutter Bench NOK  12,499  Variants -  black.jpg',
        material: 'Solid oak',
        finish: 'Black oak',
        price: 12499
      }
    ...
    specifications: {
      ...
      'Height': '43.5 cm',
      'Weight': '13 kg',
      'Dimensions (Packaged)': '125 × 45 × 47 cm',
      'Material': 'Solid oak/teak construction',
      'Hardware': 'Stainless steel details',
      'Finish Options': 'Natural oak, Natural teak, Black oak',
      'Designer': 'Niels Hvass',
      'Brand': 'Skagerak/Fritz Hansen',
      'Collection': 'Cutter',
      'Delivery Time': 'Approximately 4 weeks (made to order)',
      'Care Instructions': 'Clean with dry cloth. Apply wood oil periodically for natural finishes.'
    },
    features: [
      'Part of the popular Cutter series',
      'Designed by Niels Hvass',
      'Clean, simple and sculptural expression',
      'Counterbalance to nostalgic garden bench designs',
      'Distinctive design language',
      'Wide range of uses - indoor and outdoor',
      'One of Skagerak\'s most popular pieces',
      'Consistent use of teak, oak and stainless steel',
      'Uncompromising and rich craftsmanship',
    ...
    lifestyleImages: [
      {
        src: '/Fritz Hansen/Skagerak-Cutter-Bench/lifestyle/cutter_bench_lifestyle1.jpg',
        alt: 'Skagerak Cutter Bench in modern outdoor setting'
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h2 className="text-2xl font-light text-gray-900 mb-8 text-center">
            Explore More Cutter Collection
          </h2>
