...
export default function PanthellaFloorLampPage() {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-stone-400">/</span>
            <span className="text-stone-800 font-medium">Panthella Floor Lamp</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Louis Poulsen Panthella Floor Lamp - ${currentVariant.name}`}
                fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The Panthella Floor Lamp brings Verner Panton's iconic mushroom design to floor level. With its elegant proportions and glare-free lighting, it creates perfect ambient lighting for any living space.
              </p>
                ...
                <div className="space-y-6 text-sm text-gray-600">
                  <div>
                    ...
                    <div className="space-y-3">
                      <p className="leading-relaxed">
                        The Panthella Floor Lamp is an elegant interpretation of Verner Panton's iconic design. The characteristic mushroom-shaped shade provides both direct downward light and soft ambient light, creating the perfect atmosphere for any room.
                      </p>
                      <p className="leading-relaxed">
                        The opal acrylic shade ensures pleasant, glare-free light distribution, making it ideal for reading corners or as ambient lighting in living spaces.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span>Height:</span>
                        <span className="font-medium">129 cm</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">E27 max 100W</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Designer:</span>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Elegant floor-standing version</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <Link href="/louis-poulsen/panthella-400-table-lamp" className="group">
