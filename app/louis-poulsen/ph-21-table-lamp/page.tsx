...
export default function PH21TableLampPage() {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-stone-400">/</span>
            <span className="text-stone-800 font-medium">PH 2/1 Table Lamp</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Louis Poulsen PH 2/1 Table Lamp - ${currentVariant.name}`}
                fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The PH 2/1 Table Lamp features Poul Henningsen's iconic three-shade system that provides glare-free light. The compact design makes it perfect for desks, bedside tables, and intimate lighting situations.
              </p>
                ...
                <div className="space-y-6 text-sm text-gray-600">
                  <div>
                    ...
                    <div className="space-y-3">
                      <p className="leading-relaxed">
                        The PH 2/1 Table Lamp is based on Poul Henningsen's principle of a glare-free light, created by using a three-shade system. The lamp provides comfortable light for reading and creates a pleasant atmosphere.
                      </p>
                      <p className="leading-relaxed">
                        The shades are made of spun metal with a white painted interior that ensures soft light distribution. Available in various finishes to complement any interior style.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span>Material:</span>
                        <span className="font-medium">Spun metal</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Light Source:</span>
                        <span className="font-medium">E14 max 25W</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Designer:</span>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>Glare-free three-shade system</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Compact design for various spaces</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Iconic PH lighting principle</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Link href="/louis-poulsen/ph-35-25-table-lamp" className="group">
              <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                <div className="relative aspect-square bg-gray-50">
                  <Image
                    src="/Louis-Poulsen/PH-3½-2½-Table-Lamp/PH 3½-2½ Table Lamp NOK  15,965  Color -  Green.jpg"
                    alt="PH 3½-2½ Table Lamp"
                    fill
                    className="object-contain object-center p-4 group-hover:scale-105 transition-transform duration-300"
                    sizes="(max-width: 768px) 100vw, 33vw"
                  />
                ...
                <div className="p-4">
                  <h3 className="text-lg font-light text-gray-900 mb-2">PH 3½-2½ Table Lamp</h3>
                  <p className="text-gray-900 font-medium">kr 15,965</p>
                </div>
              </div>
            </Link>
