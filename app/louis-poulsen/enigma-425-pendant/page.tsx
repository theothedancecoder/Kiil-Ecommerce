...
export default function Enigma425PendantPage() {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-stone-400">/</span>
            <span className="text-stone-800 font-medium">Enigma 425 Pendant</span>
          </nav>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Louis Poulsen Enigma 425 Pendant - ${currentVariant.name}`}
                fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The Enigma 425 Pendant represents modern lighting innovation with its unique adjustable light distribution system. This contemporary design allows you to control both the direction and intensity of light output.
              </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <p className="leading-relaxed">
                        The Enigma 425 Pendant is a revolutionary lighting design that allows you to adjust both the direction and distribution of light. Its innovative mechanism lets you customize the lighting to suit any situation or mood.
                      </p>
                      <p className="leading-relaxed">
                        Perfect for dining areas, workspaces, or anywhere you need flexible lighting control. The sleek design complements both modern and traditional interiors.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span>Diameter:</span>
                        <span className="font-medium">42.5 cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Height:</span>
                        <span className="font-medium">18 cm</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Weight:</span>
                      ...
                      <div className="flex justify-between">
                        <span>Designer:</span>
                        <span className="font-medium">Shoichi Uchiyama</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>Adjustable light distribution system</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Contemporary minimalist design</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Perfect for dining and work areas</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Innovative lighting technology</span>
                      </li>
                    </ul>
                  </div>
                </div>
