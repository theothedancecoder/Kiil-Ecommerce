...
export default function NJPFloorLampPage() {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-stone-400">/</span>
            <span className="text-stone-800 font-medium">NJP Floor Lamp</span>
          </nav>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Louis Poulsen NJP Floor Lamp - ${currentVariant.name}`}
                fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The NJP Floor Lamp combines minimalist Scandinavian design with exceptional functionality. Its adjustable arm and shade provide precise light control, making it perfect for reading or task lighting.
              </p>
                ...
                <div className="space-y-6 text-sm text-gray-600">
                  <div>
                    ...
                    <div className="space-y-3">
                      <p className="leading-relaxed">
                        The NJP Floor Lamp represents the perfect marriage of Japanese minimalism and Scandinavian functionality. Designed by Nendo for Louis Poulsen, it features clean lines and exceptional adjustability.
                      </p>
                      <p className="leading-relaxed">
                        The lamp's arm and shade can be positioned precisely to provide optimal lighting for reading, working, or creating ambient atmosphere. Its understated elegance makes it suitable for any modern interior.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
                        <span>Designed by renowned studio Nendo</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-600 mr-2 mt-0.5">✓</span>
