...
export default function PantonWireSingle18Page() {
  ...
  const variants: ColorVariant[] = [
    {
      ...
      name: 'Black',
      colorCode: '#000000',
      image: '/Montana/Panton-wire-system/Montana_PantonWire_Single_D18.8_Black_perspective-scaled.jpg'
    },
    {
      id: 'chrome',
      name: 'Chrome',
    ...
    },
    {
      ...
      name: 'Monarch',
      colorCode: '#4A5D8A',
      image: '/Montana/Panton-wire-system/Montana_PantonWire_Single_D18.8_Monarch_perspective-scaled.jpg'
    },
    {
      id: 'pine',
      name: 'Pine',
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-stone-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-stone-800">Panton Wire Single Ø18.8</span>
          </nav>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Panton Wire Single Ø18.8 in ${currentVariant.name}`}
                fill
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-stone-600 leading-relaxed mb-6">
                In 1971, Verner Panton designed the iconic Panton Wire system. Raw yet elegant, lightweight yet 
                industrial in its design, Panton Wire Single can be used alone or in combination with other products 
                from the Panton Wire series – on the floor or hanging on the wall. Perfect for books, decorative objects, or plants.
              </p>
                ...
                <div className="mt-4 space-y-4 text-stone-600">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li><strong>Diameter:</strong> Ø 18.8 cm</li>
                      <li><strong>Depth:</strong> 17 cm</li>
                      <li><strong>Weight:</strong> 0.5 kg</li>
                      <li><strong>Material:</strong> Powder-coated steel wire</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>• Perfect for books, plants, or decorative objects</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-90 rounded p-3">
                ...
                <p className="text-sm text-stone-600">Larger single wire shelf</p>
              </div>
            </div>
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              <Image
