...
export default function ReadBookshelfPage() {
      ...
      variants: [
        {
          ...
          name: 'New White',
          colorCode: '#FAFAFA',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_NewWhite_Suspended_Perspective.png'
        },
        {
          id: 'nordic',
          name: 'Nordic',
        ...
        },
        {
          ...
          name: 'Vanilla',
          colorCode: '#F5F5DC',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Vanilla_Suspended_Perspective.png'
        },
        {
          id: 'monarch',
          name: 'Monarch',
        ...
        },
        {
          ...
          name: 'Anthracite',
          colorCode: '#3A3A3A',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Anthracite_Suspended_Perspective.jpg'
        },
        {
          id: 'mushroom',
          name: 'Mushroom',
          colorCode: '#B8A082',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Mushroom_Suspended_Perspective.png'
        }
      ]
    },
    {
      ...
      variants: [
        {
          ...
          name: 'New White',
          colorCode: '#FAFAFA',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_NewWhite_PlinthH3_Perspective.png'
        },
        {
          id: 'nordic',
          name: 'Nordic',
          colorCode: '#E8E8E8',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Nordic_PlinthH3_Perspective.jpg'
        },
        {
          id: 'vanilla',
          name: 'Vanilla',
          colorCode: '#F5F5DC',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Vanilla_PlinthH3_Perspective.png'
        },
        {
          id: 'monarch',
          name: 'Monarch',
          colorCode: '#4A5D8A',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Monarch_PlinthH3_Perspective.jpg'
        },
        {
          id: 'anthracite',
          name: 'Anthracite',
          colorCode: '#3A3A3A',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Anthracite_PlinthH3_Perspective.jpg'
        },
        {
          id: 'mushroom',
          name: 'Mushroom',
          colorCode: '#B8A082',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Mushroom_PlinthH3_Perspective.png'
        }
      ]
    },
    {
      ...
      variants: [
        {
          ...
          name: 'New White',
          colorCode: '#FAFAFA',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_NewWhite_PlinthH7_Perspective.jpg'
        },
        {
          id: 'nordic',
          name: 'Nordic',
          colorCode: '#E8E8E8',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Nordic_PlinthH7_Perspective.jpg'
        },
        {
          id: 'vanilla',
          name: 'Vanilla',
          colorCode: '#F5F5DC',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Vanilla_PlinthH7_Perspective.png'
        },
        {
          id: 'monarch',
          name: 'Monarch',
          colorCode: '#4A5D8A',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Monarch_PlinthH7_Perspective.png'
        },
        {
          id: 'anthracite',
          name: 'Anthracite',
          colorCode: '#3A3A3A',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Anthracite_PlinthH7_Perspective.jpg'
        },
        {
          id: 'mushroom',
          name: 'Mushroom',
          colorCode: '#B8A082',
          image: '/Montana/Read-bookshelf/Montana_Selection_READ_Mushroom_PlinthH7_Perspective.jpg'
        }
      ]
    }
  ];
  ...
  const getPrice = (mountingId: string) => {
    switch (mountingId) {
      case 'suspended':
        return 40821; // Wall mounted
      case 'plinth-h3':
        return 40731; // 3cm plinth
      case 'plinth-h7':
        return 40731; // 7cm plinth
      default:
        return 40821;
    }
  };
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-stone-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-stone-800">Read Bookshelf</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Read Bookshelf ${currentMounting.name} in ${currentVariant.name}`}
                fill
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-stone-800">Read in Living Spaces</h3>
              <div className="grid grid-cols-1 gap-4">
                <div className="relative aspect-[4/3] bg-gray-50 rounded-lg overflow-hidden">
                  <Image
                    ...
                    alt="Read bookshelf in modern interior setting"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute bottom-3 left-3 right-3 bg-white bg-opacity-90 rounded p-2">
                    <p className="text-sm text-stone-600">Modern Reading Corner</p>
                  </div>
                </div>
                <div className="relative aspect-[4/3] bg-gray-50 rounded-lg overflow-hidden">
                  <Image
                    src="/Montana/Read-bookshelf/lifestyle/Montana_Read_Boulevard_Ambient02_s101_2016_W.jpg"
                    alt="Read bookshelf in contemporary setting"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute bottom-3 left-3 right-3 bg-white bg-opacity-90 rounded p-2">
                    <p className="text-sm text-stone-600">Contemporary Display</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-stone-600 leading-relaxed mb-6">
                Montana's classic bookshelf solution! Get READ – a bookcase with a colorful personality. 
                Make it the home for all your favorite things and books in your living room or home office. 
                READ is the classic bookcase composed of displaced shelves in different sizes perfect for 
                books and bits and bobs. The bookcase consists of six individual modules that can eventually 
                be arranged into new storage solutions.
              </p>
                ...
                <div className="mt-4 space-y-4 text-stone-600">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li><strong>Finish:</strong> Montana Selection colors (40 colors available)</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>• Composed of displaced shelves in different sizes</li>
                      <li>• Six individual modules that can be rearranged</li>
                      <li>• Perfect for books and decorative objects</li>
                      <li>• Available in all 40 Montana colors</li>
                      <li>• Multiple mounting configurations (wall-mounted or plinth)</li>
                      <li>• Modular system allows new storage solutions</li>
                      <li>• High-quality lacquered finish</li>
                      <li>• Suitable for living rooms and home offices</li>
                      <li>• Colorful personality with functional design</li>
                    </ul>
                  </div>
                  <div>
        ...
        <section className="mt-20">
          <h2 className="text-2xl font-serif text-stone-800 mb-8 text-center">
            Complete Your Montana Library
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              <Image
                src="/Montana/Loom-bookshelf/Montana_Selection_LOOM_Vanilla_Suspended_Perspective.png"
                alt="Loom Bookshelf"
                fill
                className="object-contain object-center p-4"
              />
              <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-90 rounded p-3">
                <h3 className="font-medium text-stone-800">Loom Bookshelf</h3>
                <p className="text-sm text-stone-600">Geometric storage solution</p>
              </div>
            </div>
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              <Image
