...
export default function PantonWireExtended18Page() {
  ...
  const variants: ColorVariant[] = [
    ...
    },
    {
      ...
      name: 'Chrome',
      colorCode: '#C0C0C0',
      image: '/Montana/Panton-wire-system/Montana_PantonWire_Extended_D18.8_Chrome_perspective-scaled.jpg'
    },
    {
      id: 'monarch',
      name: 'Monarch',
      colorCode: '#4A5D8A',
      image: '/Montana/Panton-wire-system/Montana_PantonWire_Extended_D18.8_Monarch_perspective-scaled.jpg'
    },
    {
      id: 'pine',
      name: 'Pine',
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-stone-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-stone-800">Panton Wire Extended Ø18.8</span>
          </nav>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden">
              <Image
                ...
                alt={`Panton Wire Extended Ø18.8 in ${currentVariant.name}`}
                fill
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="relative aspect-[4/3] bg-gray-50 rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="absolute bottom-3 left-3 right-3 bg-white bg-opacity-90 rounded p-2">
                    <p className="text-sm text-stone-600">Modular Display</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-stone-600 leading-relaxed mb-6">
                The extended version of Verner Panton's iconic wire shelf system from 1971. This modular 
                wire shelf with Ø18.8 cm diameter features multiple levels, creating a dynamic sculptural 
                display while providing practical storage for books, plants, and decorative objects.
              </p>
                ...
                <div className="mt-4 space-y-4 text-stone-600">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li><strong>Depth:</strong> 18.8 cm</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>• Extended multi-level wire system</li>
                      <li>• Creates dynamic sculptural display</li>
                      <li>• Multiple shelves for varied storage</li>
                      <li>• Perfect for books, plants, or collections</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-90 rounded p-3">
                ...
                <p className="text-sm text-stone-600">Single wire shelf</p>
              </div>
            </div>
            <div className="relative aspect-video bg-gray-50 rounded-lg overflow-hidden">
              <Image
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-90 rounded p-3">
                ...
                <p className="text-sm text-stone-600">Larger extended system</p>
              </div>
            </div>
          </div>
