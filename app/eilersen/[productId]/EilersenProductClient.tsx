...
interface EilersenProductClientProps {
  product: Product;
}

export default function EilersenProductClient({ product }: EilersenProductClientProps) {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link href="/eilersen" className="text-stone-600 hover:text-stone-800">
              Eilersen
            </Link>
            <span className="text-stone-400">/</span>
