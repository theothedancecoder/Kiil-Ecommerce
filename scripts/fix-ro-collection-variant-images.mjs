...
// Correct variant data with specific images for each variant
...
async function fixRoCollectionVariantImages() {
  console.log('🔧 Fixing RO Collection variant images with correct specific images...\n');
  ...
  console.log('\n🎉 RO Collection variant images fixed!');
  console.log('\n💡 Next steps:');
  console.log('1. All variants now have their specific correct images');
  console.log('2. Lifestyle images have been added where available');
  console.log('3. Test the /ro-collection pages to verify variant selection works correctly');
}

// Run the fix
fixRoCollectionVariantImages().catch(console.error);
