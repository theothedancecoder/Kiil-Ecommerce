...
// Mapping of folder names to product IDs
const productIdMapping = {
  'bm71-library-table': 'product-fredericia-bm71-library-table',
  'canvas-chair': 'product-fredericia-canvas-chair',
  'corona-armchair': 'product-fredericia-corona-armchair',
  'delphi-elements-sofa': 'product-fredericia-delphi-elements-sofa',
  'delphi-sofa': 'product-fredericia-delphi-sofa',
  'ej220-sofa': 'product-fredericia-ej220-sofa-2-seater',
  'insula-piccolo-side-table': 'product-fredericia-insula-piccolo-side-table',
  'mogensen-dining-table': 'product-fredericia-mogensen-dining-table',
  'mogensen-j39-dining-chair': 'product-fredericia-mogensen-j39-dining-chair',
  'piloti-coffee-table': 'product-fredericia-piloti-coffee-table',
  'post-dining-chair': 'product-fredericia-post-dining-chair',
  'risom-magazine-table': 'product-fredericia-risom-magazine-table',
  'trinidad-chair': 'product-fredericia-trinidad-chair',
  'wegner-j16-rocking-chair': 'product-fredericia-wegner-j16-rocking-chair',
...
async function processAllProcessedImages() {
  ...
  console.log('🚀 Starting upload of processed Fredericia images to Sanity...\n');
  ...
  for (const productDir of productDirs) {
    ...
    for (const imageFile of imageFiles) {
      ...
      const filename = `fredericia-${productDir}-${imageFile}`;
