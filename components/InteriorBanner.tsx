...
const InteriorBanner = () => {
  ...
  return (
    <div className="flex mx-auto px-6 md:px-8 lg:px-0 max-w-[95%] lg:max-w-[1072px]">
      {/* Placeholder box */}
      <div 
        className="bg-[#fff5f5] rounded-l-xl flex flex-col justify-center items-center p-4 md:p-6"
        style={{
          width: "280px",
          height: "177.97px"
        }}
      >
        ...
        <button className="bg-red-600 hover:bg-red-700 text-white px-4 md:px-6 py-2 rounded-lg font-medium transition-colors text-sm md:text-base">
          {t("interior.banner.shopNow")}
        </button>
      </div>
      
      {/* Main banner */}
      <div 
        className="relative bg-[#fff5f5] overflow-hidden rounded-r-xl"
        style={{
          width: "100%",
          maxWidth: "792px",
          height: "177.97px",
      ...
      >
        <Image
          src="/interior-collection/DelphiSofa4511_TableauCoffeeTable1966_SpanishChair2226_LocusBowl8215-scaled.jpg.avif"
          alt="interior collection banner"
          fill
