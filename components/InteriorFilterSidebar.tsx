...
interface InteriorFilterSidebarProps {
  filters: FilterState;
  onFiltersChange: (filters: FilterState) => void;
}

const InteriorFilterSidebar = ({ filters, onFiltersChange }: InteriorFilterSidebarProps) => {
  const { t } = useLanguage();
...
export default InteriorFilterSidebar;
